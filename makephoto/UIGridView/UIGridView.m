...
{
//    
//    NSLog([@"00000" stringByAppendingString:[NSString stringWithFormat:@"%d",[uiGridViewDelegate numberOfCellsOfGridView:self]]]);
//    NSLog([@"00001" stringByAppendingString:[NSString stringWithFormat:@"%d",[uiGridViewDelegate numberOfColumnsOfGridView:self]]]);
////    
...
//    NSMutableArray *images=[self readImageFromDocuments :8];
...
//        
//        NSString *filePath2 = [documentsDirectory stringByAppendingPathComponent:[[NSString stringWithFormat:@"%d",i] stringByAppendingString:@".jpg"]];
//        
